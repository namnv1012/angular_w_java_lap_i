package com.laptop.shopping.restful.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        ...
        com.laptop.shopping.exception.restful.EmailAlreadyUsedException problem = new com.laptop.shopping.exception.restful.EmailAlreadyUsedException();
        return create(
            problem,
            request,
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        ...
        return create(new com.laptop.shopping.exception.restful.InvalidPasswordException(), request);
    }
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.mobile.shopping");
    }
}
