...
import com.laptop.shopping.security.jwt.JWTConfigurer;
import com.laptop.shopping.security.jwt.TokenProvider;
import com.laptop.shopping.security.*;
import com.laptop.shopping.security.jwt.*;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .antMatchers("/api/passers/**").permitAll()
            .antMatchers("/api/register").permitAll()
            .antMatchers("/api/activate").permitAll()
            .antMatchers("/api/customer/**").permitAll()
            .antMatchers("/api/account/register-customer").permitAll()
