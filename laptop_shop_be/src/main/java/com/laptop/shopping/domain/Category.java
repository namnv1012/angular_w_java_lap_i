...
public class Category implements Serializable {
    ...
    public Category createDate(Instant createDate) {
    ...
    public Category createName(String createName) {
    ...
    public Category updateDate(Instant updateDate) {
    ...
    public Category updateName(String updateName) {
